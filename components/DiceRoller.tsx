      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
        ...
        >
          <div className="p-6 text-center">
            <h3 className="text-2xl font-bold text-indigo-400 mb-2">Desafio de {request.attribute}</h3>
            ...
            <div className="flex justify-center mb-8">
              <motion.div
                ...
                className="w-24 h-24 flex items-center justify-center bg-indigo-900/30 rounded-full border-2 border-indigo-500"
              >
                {result ? (
