    ...
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto p-4 md:p-8 space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
           ...
           <div className="bg-slate-900 p-6 rounded-xl border border-slate-800">
              <h3 className="text-2xl font-bold text-purple-400 mb-4">2. O Artista (Visual)</h3>
              <p className="text-slate-300 leading-relaxed">
           ...
           <div className="bg-slate-900 p-6 rounded-xl border border-slate-800">
              <h3 className="text-2xl font-bold text-purple-400 mb-4">3. O Juiz (Regras)</h3>
              <p className="text-slate-300 leading-relaxed">
        ...
        <div className="bg-purple-900/20 p-8 rounded-xl text-center space-y-6">
